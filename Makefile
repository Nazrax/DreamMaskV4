...
PRJSRC=main.c power.c clock.c serial.c flash.c spi.c commands.c adc.c buttons.c calib_32kHz.c leds.c morse.c detector.c ringbuffer.c alarm.c
...
fuses:
	$(AVRDUDE) -c $(AVRDUDE_PROGRAMMERID)   \
	 -p $(PROGRAMMER_MCU) -P $(AVRDUDE_PORT) -e        \
	 -U lfuse:w:0x7e:m -U hfuse:w:0xd9:m -U efuse:w:0x07:m 
